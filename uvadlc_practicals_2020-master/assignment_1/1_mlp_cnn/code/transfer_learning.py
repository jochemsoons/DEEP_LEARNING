...
def train():
    ...
    # Plot loss figure.
    plt.figure()
    plt.title("Train and test loss of pretrained {} model".format(FLAGS.model))
    plt.xlabel("Iteration step")
    plt.ylabel("Cross-entropy loss")
    plt.plot(eval_steps, train_loss_list, label='Train loss')
    plt.plot(eval_steps, test_loss_list, label='Test loss')
    plt.legend()
    plt.savefig("./CNN_pytorch_results/{}_pretrained_loss.png".format(FLAGS.model))

    # Plot accuracy figure.
    plt.figure()
    plt.title("Train and test accuracy of pretrained {} model".format(FLAGS.model))
    plt.xlabel("Iteration step")
    plt.ylabel("Accuracy")
    plt.plot(eval_steps, train_acc_list, label="Train acc")
    plt.plot(eval_steps, test_acc_list, label="Test acc")
    plt.legend()
    plt.savefig("./CNN_pytorch_results/{}_pretrained_acc.png".format(FLAGS.model))
    ########################
    # END OF YOUR CODE    #
    #######################
